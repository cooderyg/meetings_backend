 ...
 * ```
 */
export function getMatchingErrorCodes(pattern: string): HierarchicalErrorCode[] {
  const allErrorCodes = Object.keys(HIERARCHICAL_ERROR_DEFINITIONS) as HierarchicalErrorCode[];
 ...
 */
export function generateErrorCodeExample(errorCode: HierarchicalErrorCode): Record<string, any> {
